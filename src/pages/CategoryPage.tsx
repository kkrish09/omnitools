  ...
  return (
    <div>
      ...
      <div className="mb-8 flex items-start gap-4">
        <span style={{ display: 'flex', width: '3.5rem', height: '3.5rem', flexShrink: 0, alignItems: 'center', justifyContent: 'center', borderRadius: 'var(--radius-xl)', background: `${category.gradient}18`, color: category.gradient }}>
        ...
        {tools.map((t) => (
          ...
          >
            <div className="flex items-center gap-2">
              <t.icon size={24} style={{ color: 'var(--color-primary)' }} />
